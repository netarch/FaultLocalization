 ...
 * \param address The source ip address for this TcpHeader
 */
  void SetSourceAddress (Ipv4Address address);

  /**
   * \brief Set the destination ip address
   * \param address the destination ip address for this TcpHeader
   */
  void SetDestinationAddress (Ipv4Address address);
  /**
...
//Getters
   ...
   * \return The source address for this TcpHeader
   */
  Address GetSourceAddress () const;

  /**
   * \brief Get the destination address
   * \return the destination address for this TcpHeader
   */
