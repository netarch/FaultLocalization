...
{
  Ptr<Socket> socket = m_tcp->CreateSocket ();
  Ptr<TcpSocketBase> dummyTcpSocket = socket->GetObject<TcpSocketBase>();
  //std::cout<<"CreateSocket(tcp-socket-base): "<<dummyTcpSocket->GetTypeId()<<std::endl;
  return socket;
}
