...
int main(int argc, char *argv[]) {
    ...
    for (auto [dest, sw, failparam] : failed_components)
        data.failed_devices.insert(pair<int, double>(sw, failparam));
    ...
    PDD precision_recall =
        GetPrecisionRecall(failed_devices, estimator_hypothesis, &data);
