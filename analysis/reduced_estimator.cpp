...
int main(int argc, char *argv[]) {
    ...
    double min_start_time_ms = atof(argv[4]) * 1000.0,
           max_finish_time_ms = atof(argv[5]) * 1000.0;
    ...
    SetInputForReduced(estimator, &data, &reduced_data, reduced_map_file,
    ...
    PDD precision_recall = GetPrecisionRecall(
        failed_links_set, estimator_hypothesis, &reduced_data);
    cout << "Output Hypothesis: "
         << reduced_data.IdsToLinks(estimator_hypothesis) << " precsion_recall "
