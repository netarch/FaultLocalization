...
void
TcpHeader::SetSourceAddress (Ipv4Address address)
{
  m_source = address;
}

void
TcpHeader::SetDestinationAddress (Ipv4Address address)
{
...
Address
TcpHeader::GetSourceAddress () const
{
  return m_source;
}

Address
TcpHeader::GetDestinationAddress () const
{
                               ...
                               uint8_t protocol)
{
  ...
  //std::cout<<"Initialize cheskum "<<source<<" : "<<destination<<" : "<<this<<std::endl;
  m_protocol = protocol;
}
